...
class TestJobCancellationFlag:
    ...
    async def test_set_and_check_cancellation(self) -> None:
        """Test setting and checking cancellation flag."""
        flag = JobCancellationFlag()
        try:
            job_id = "test_job_123"
...
class TestRateLimiter:
    ...
    async def test_is_rate_limited(self) -> None:
...
class TestBrowserPoolStatus:
    ...
    async def test_update_and_get_status(self) -> None:
...
class TestJobProgressCache:
    ...
    async def test_set_and_get_progress(self) -> None:
        """Test setting and getting job progress."""
        cache = JobProgressCache()
        try:
